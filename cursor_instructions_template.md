...
- [0. セットアップ（【Cursor対応項目】）](#0-セットアッププロジェクト開始時に実行すること)
- [1. cursor/rules の登録（【人が対応要！】最初の1回）](#1-cursorrules-の登録)
- [2. スクリプト作成 補足（【Cursor対応項目】）](#2-スクリプト作成-補足アプリごとに指定がある場合)
- [3. Markdown 全般の共通ルール（全 .md に適用）（【Cursor対応項目】）](#3-markdown-文書の共通ルール全-md-に適用)
- [4. README 作成・更新（【Cursor対応項目】）](#4-readme-作成更新)
- [5. 教材4種 作成・更新（【Cursor対応項目】）](#5-教材4種-作成更新)
- [6. 知見の追記先（【Cursor対応項目】）](#6-エラーデバッグ単体テストの知見の追記先)
- [7. 文書・mdc の更新 実施手順（【Cursor対応項目】）](#7-文書mdc-の更新-実施手順cursor-が完璧に更新するための手順)
...
- [8. プロジェクト開始時の実行順序（【Cursor対応項目】）](#8-プロジェクト開始時の実行順序)
- [9. 修正・機能追加後の実行（【Cursor対応項目】）](#9-修正機能追加後の実行)
- [10. .mdc の内容（参照用）（【Cursor対応項目】）](#10-mdc-の内容参照用)
